          ...
          <div class="card-body">
            <div class="row">
              <div class="col-xl-3 col-lg-2 text-center">
                <img src="{{ url('admin-assets/images/pngs/profit.png') }}" alt="img" class="w-95">
              </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover text-nowrap mb-0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <img src="{{ url('admin-assets/images/users/3.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32 mr-2">
                       Vashti Riccio
                    </td>
                    <td>#89345</td>
                    <td>Sport Shooes</td>
                  ...
                  <tr>
                    <td>
                      <img src="{{ url('admin-assets/images/users/4.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32 mr-2">
                      Harriett Lauver
                    </td>
                    <td>#39281</td>
                    <td>T-Shirt</td>
                  ...
                  <tr>
                    <td>
                      <img src="{{ url('admin-assets/images/users/5.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32 mr-2">
                      Darci Faw
                    </td>
                    <td>#35825</td>
                    <td>Hand Bag</td>
                  ...
                  <tr>
                    <td>
                      <img src="{{ url('admin-assets/images/users/6.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32 mr-2">
                      Jamie Norville
                    </td>
                    <td>#62391</td>
                    <td>Lather Watch</td>
                  ...
                  <tr>
                    <td>
                      <img src="{{ url('admin-assets/images/users/7.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32 mr-2">
                      Danae Kaba
                    </td>
                    <td>#92481</td>
                    <td>Laptop</td>
                  ...
                  <tr>
                    <td>
                      <img src="{{ url('admin-assets/images/users/8.jpg') }}" alt="profile-user" class="brround  avatar-sm w-32 mr-2">
                      Jeromy Tricarico
                    </td>
                    <td>#29381</td>
                    <td>Office Chair</td>
          ...
          <div class="card-body">
            <div class="activity-block">
              <ul class="task-list user-tasks">
                <li>
                  <span class="avatar avatar-md brround cover-image task-icon1" data-image-src="{{ url('admin-assets/images/users/1.jpg') }}"></span>
                ...
                <li>
                  <span class="avatar avatar-md brround cover-image task-icon1" data-image-src="{{ url('admin-assets/images/users/2.jpg') }}"></span>
                ...
                <li>
                  <span class="avatar avatar-md brround cover-image task-icon1" data-image-src="{{ url('admin-assets/images/users/8.jpg') }}"></span>
                ...
                <li>
                  <span class="avatar avatar-md brround cover-image task-icon1" data-image-src="{{ url('admin-assets/images/users/9.jpg') }}"></span>
        ...
        <div class="card">
          ...
          <div class="customer-scroll">
            <div class="list-group-item d-flex  align-items-center border-top-0 border-left-0 border-right-0">
              <div class="mr-2">
                <span class="avatar avatar-md brround cover-image" data-image-src="{{ url('admin-assets/images/users/1.jpg') }}"></span>
              </div>
              <div class="">
            ...
            <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
              <div class="mr-2">
                <span class="avatar avatar-md brround cover-image" data-image-src="{{ url('admin-assets/images/users/13.jpg') }}"></span>
              </div>
              <div class="">
            ...
            <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
              <div class="mr-2">
                <span class="avatar avatar-md brround cover-image" data-image-src="{{ url('admin-assets/images/users/14.jpg') }}"></span>
              </div>
              <div class="">
            ...
            <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
              <div class="mr-2">
                <span class="avatar avatar-md brround cover-image" data-image-src="{{ url('admin-assets/images/users/6.jpg') }}"></span>
              </div>
              <div class="">
            ...
            <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
              <div class="mr-2">
                <span class="avatar avatar-md brround cover-image" data-image-src="{{ url('admin-assets/images/users/3.jpg') }}"></span>
              </div>
              <div class="">
            ...
            <div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
              <div class="mr-2">
                <span class="avatar avatar-md brround cover-image" data-image-src="{{ url('admin-assets/images/users/7.jpg') }}"></span>
              </div>
              <div class="">
            ...
            <div class="table-responsive">
              <table class="table card-table border table-vcenter text-nowrap align-items-center">
                ...
                <tbody>
                  <tr>
                    <td>
                    <img src="{{ url('admin-assets/images/pngs/1.png') }}" alt="img" class="h-7 w-7">
                  ...
                  <tr>
                    <td>
                    <img src="{{ url('admin-assets/images/pngs/2.png') }}" alt="img" class="h-7 w-7">
                    <p class="d-inline-block align-middle mb-0 ml-1">
                      <a href="" class="d-inline-block align-middle mb-0 product-name text-dark font-weight-semibold">Arm Chair</a>
                      <br>
                  ...
                  <tr>
                    <td>
                    <img src="{{ url('admin-assets/images/pngs/3.png') }}" alt="img" class="h-7 w-7">
                    <p class="d-inline-block align-middle mb-0 ml-1">
                      <a href="" class="d-inline-block align-middle mb-0 product-name text-dark font-weight-semibold">Arm Chair</a>
                      <br>
                  ...
                  <tr>
                    <td>
                    <img src="{{ url('admin-assets/images/pngs/4.png') }}" alt="img" class="h-7 w-7">
                    <p class="d-inline-block align-middle mb-0 ml-1">
                      <a href="" class="d-inline-block align-middle mb-0 product-name text-dark font-weight-semibold">Arm Chair</a>
                      <br>
