...
<aside class="app-sidebar">
  <div class="side-header">
    <a class="header-brand1" href="index.html">
      <img src="{{ url('admin-assets/images/brand/logo_qlife.png') }}" class="header-brand-img desktop-logo" alt="logo">
      <img src="{{ url('admin-assets/images/brand/logo_qlife.png') }}" class="header-brand-img toggle-logo" alt="logo">
      <img src="{{ url('admin-assets/images/brand/logo_qlife.png') }}" class="header-brand-img light-logo" alt="logo">
      <img src="{{ url('admin-assets/images/brand/logo_qlife.png') }}" class="header-brand-img light-logo1" alt="logo">
    </a><!-- LOGO -->
  </div>
  <ul class="side-menu">
    <li><h3>Main</h3></li>
    ...
    <li class="slide is-expanded">
      <a class="side-menu__item" data-toggle="slide" href="#">
        ...
        <span class="side-menu__label">Menus</span><i class="angle fa fa-angle-right"></i>
      </a>
      <ul class="slide-menu">
        <li><a class="slide-item" href="{{ route('admin.booking-types.index') }}"><span>Booking Types</span></a></li>
        <li><a class="slide-item" href="{{ route('admin.appointments.index') }}"><span>Appointments</span></a></li>
        <li><a class="slide-item" href="{{ route('admin.appointment-dates.index') }}"><span>Appointment Schedules</span></a></li>
        <li><a class="slide-item" href="{{ route('admin.configurations.index') }}"><span>Configuration</span></a></li>
      </ul>
    </li>
