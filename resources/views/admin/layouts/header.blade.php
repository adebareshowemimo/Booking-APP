...
<div class="app-header header">
  <div class="container-fluid">
    <div class="d-flex">
      <a class="header-brand d-md-none" href="{{ route("admin.index") }}">
        <img src="{{ url('admin-assets/images/brand/logo_qlife.png') }}" class="header-brand-img mobile-icon" alt="logo">
        <img src="{{ url('admin-assets/images/brand/logo_qlife.png') }}" class="header-brand-img desktop-logo mobile-logo" alt="logo">
      </a>
      ...
      <div class="d-flex ml-auto header-right-icons header-search-icon">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
            <div class="message-menu">
              <a class="dropdown-item d-flex pb-3" href="#">
                <span class="avatar avatar-md brround mr-3 align-self-center cover-image" data-image-src="{{ url('admin-assets/images/users/1.jpg') }}"></span>
                <div>
              ...
              <a class="dropdown-item d-flex pb-3" href="#">
                <span class="avatar avatar-md brround mr-3 align-self-center cover-image" data-image-src="{{ url('admin-assets/images/users/12.jpg') }}"></span>
                <div>
              ...
              <a class="dropdown-item d-flex pb-3" href="#">
                <span class="avatar avatar-md brround mr-3 align-self-center cover-image" data-image-src="{{ url('admin-assets/images/users/4.jpg') }}"></span>
                <div>
              ...
              <a class="dropdown-item d-flex pb-3" href="#">
                <span class="avatar avatar-md brround mr-3 align-self-center cover-image" data-image-src="{{ url('admin-assets/images/users/15.jpg') }}"></span>
                <div>
        ...
        <div class="dropdown profile-1">
          <a href="#" data-toggle="dropdown" class="nav-link pl-2 pr-2  leading-none d-flex">
            <span>
              <img src="{{ url('admin-assets/images/users/10.jpg') }}" alt="profile-user" class="avatar  mr-xl-3 profile-user brround cover-image">
            </span>
            <div class="text-center mt-1 d-none d-xl-block">
              <h6 class="text-dark mb-0 fs-13 font-weight-semibold">{{ optional(auth()->user())->name }}</h6>
            </div>
          </a>
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
